...
setwd("C:/Users/sunny/Desktop/PDfunction/SupplementaryMaterial/TableS2/output")
#define patterns to be recognized
sourcefiledir<-"C:/Users/sunny/Desktop/PDfunction/SupplementaryMaterial/TableS2/data"
verzeichnis<-"C:/Users/sunny/Desktop/PDfunction/SupplementaryMaterial/TableS2/data"
#read in additional info about strains and antibiotics of the dataset to analyze
samplenames<-read.table("C:/Users/sunny/Desktop/PDfunction/SupplementaryMaterial/TableS2/data/samplenames_panel.txt",sep="\t",header=T)
...
singleplots <- loadWorkbook("singleplot_statistics_Panel.xlsx", create = TRUE)
