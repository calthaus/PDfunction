...
setwd("C:/Users/sunny/Desktop/PDfunction/Figure3/output")
samplenames<-read.table("C:/Users/sunny/Desktop/PDfunction/Figure3/data/samplenames_wt.txt",sep="\t",header=T)
...
sourcefiledir<-"C:/Users/sunny/Desktop/PDfunction/Figure3/data"
verzeichnis<-"C:/Users/sunny/Desktop/PDfunction/Figure3/data"
...
for(j in unique(mydata$replicate)){
  ...
  #legend(x=6.5,y=4000000000,legend=conc,col=mypalette,pch=1,cex=1.8,bty="n",title="conc.[mg/L]",xpd=T)
  #legend(x=6.5,y=4000000000,legend=conc,col=mypalette,pch=1,cex=1.2,bty="n",title="conc.[mg/L]",xpd=T)
  #legend("bottomleft",legend=conc,inset=0.02,col=mypalette,pch=1,cex=1.2,bty="n",title="conc.[mg/L]",xpd=T)
  par(savefont)
  legend(("bottomleft" ),legend=conc,lty=1,inset=0.02,col=mypalette,lwd=2,pch=1,cex=1.2,bty="n",title="conc.[mg/L]",xpd=T)
  #legend("topright",legend=antibiotics,cex=1.8,bty="n",xpd=T)
