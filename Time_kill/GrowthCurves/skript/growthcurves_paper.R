...
for (i in strains){
  ...
  plot(data$time[data$strain==i],data$CFU[data$strain==i],xlab="time[h]",cex.lab=1.3,ylab="bacteria[CFU/ml]",type="n",log="y",cex=1.5)
  ...
  legend("topleft",c("Experiment 1","Experiment 2","Experiment 3"),pch=1,col=c(2,3,4),bty="n")
  dev.off()
}
