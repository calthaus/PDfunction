...
color=c("#1B9E77","#D95F02","#7570B3","#E7298A","#66A61E","black","black")
...
legend("bottomleft",legend=strainname, bty="n",col=c("#1B9E77","#D95F02","#7570B3","#E7298A","#66A61E","black"),lty=c(1,1,1,1,1,1,1),lwd=3, cex=1.5)
dev.off()