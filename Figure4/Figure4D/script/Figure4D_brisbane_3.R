...
library("magicaxis")
library("XLConnect")
pdf("figure4D_3.pdf",width = 9, height = 8)
means<-c()
m<-1
letter=""
...
data<-readWorksheetFromFile("C:/Users/sunny/Desktop/PDfunction/Figure4/Figure4D/data/summary_statistics_9AB_3.xlsx", sheet = 2, header = TRUE, startCol = 0, startRow = 0)
par(mar=c(4.7,5,2,7))
par(oma=c(0,0,0,0))
...
strainname<-c("chloramphenicole","tetracycline")
legend("topleft",legend=letter,bty="n",inset=c(-0.1,-0.05), cex=3.6) 
legend("bottomleft",legend=strainname, bty="n",col=c("#FF000099" ,"#00FF0099"),lty=c(1,1),lwd=6, cex=1.5)
dev.off()