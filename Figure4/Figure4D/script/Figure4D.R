...
data<-readWorksheetFromFile("C:/Users/sunny/Desktop/PDfunction/Figure4/Figure4D/data/summary_statistics_9AB.xlsx", sheet = 2, header = TRUE, startCol = 0, startRow = 0)
par(mar=c(4.7,5,2,7))
par(oma=c(0,0,0,0))
...
curve(psi(data$psi_max[m],data$psi_min[m],data$Kappa[m],data$zMIC[m],x),1e-7,10000,add=TRUE,col=color[m],lwd=3)
m=m+1
print(m)
}
